...
bull_durham = media.Movie("Bull Durham",
                        "A witty blend of sports drama, intelligent comedy and sexy romance Bull Durham is an ideal date film. ",
...
badnews_bears = media.Movie("Bad News Bears",
                        "The success of this underdog comedy from director Michael Ritchie almost single-handedly spawned the kids' sports film boom of the 1980s and '90s.",
...
bangthe_drumslowly = media.Movie("Bang the Drum Slowly",
                        ...
                        "https://upload.wikimedia.org/wikipedia/en/0/0e/Bang_the_Drum_Slowly_poster.jpg",
...
eightmen_out = media.Movie("Eight Men Out",
                        "Bang the Drum Slowly is a touching melodrama that explores the inner workings of a baseball club and its players' personalities with remarkable depth.",
                        "https://upload.wikimedia.org/wikipedia/en/4/41/Eight_Men_Out_DVD_cover.jpg",
...
movies = [bull_durham, moneyball, badnews_bears, bangthe_drumslowly, aleague_oftheirown, eightmen_out]
